...
genai.configure(api_key="AIzaSyC4RQOc7G96569C-0FowyyzYCG1i-P5uso")
...
# Update model initialization in refine_inputs function
...
# Update generate_itinerary function
